...
<div id="LAY_music" >
    ...
    <div class="body">
        <div class="layui-btn-container" style="text-align: center;">
            <button type="button" class="layui-btn layui-btn-primary layui-btn-radius">国语</button>
            <button type="button" class="layui-btn layui-btn-radius">粤语</button>
            <button type="button" class="layui-btn layui-btn-normal layui-btn-radius">英语</button>
            <button type="button" class="layui-btn layui-btn-warm layui-btn-radius">韩语</button>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        function loadTableData(type) {
            var url = '/getMusicByType?type=' + type;
        ...
        $('.layui-btn-container button').click(function() {
            ...
            loadTableData(type);  // 调用函数根据选择的语言加载表格数据
        });

        $('.layui-btn-container button:contains("国语")').trigger('click');
    });
</script>
<script>
    layui.use(function() {
