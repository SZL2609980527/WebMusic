...
<script>
    ...
    $(".body-data").ready(function() {
        $.ajax({
            url: "/getOneList?id="+getUrlParameter("listId"), //后端处理数据的URL
            type: "GET",
            dataType: "json",
...
<script>
    layui.use(function() {
        ...
        if (getUrlParameter("listId")<5){
            table.render({
                elem: '#listMusic',
                url: '/getlist?id='+getUrlParameter("listId"),
                skin: 'line',
                cols: [[
            ...
            table.render({
                ...
                cols: [[
                    ...
                    {field: 'album', width: 150, title: '专辑'},
                    {field: 'type', width: 150, title: '类型'},
                    {fixed: 'right', title:'操作', width: 150, minWidth: 125, toolbar: '#bartool'}
                ]],
            });
        }
        //工具栏事件
