...
<div id="LAY_music" >
    ...
    <div class="body">
        <div class="topList-title" style="margin-left: 200px; margin-top: 30px;">
            <h1>流行榜指数</h1>
            <span class="topList_switch">
                <label class="topList_switch_data"></label>
            </span>
            &nbsp;&nbsp;
            <label>榜单规则：站内播放次数排名前20首歌</label>
        </div>
...
<script>
    var currentTime = $('.topList_switch_data');
    var currentDate = new Date();
    var currentDateTimeString = currentDate.toLocaleString();
    currentTime.text( currentDateTimeString);
</script>
<script>
    layui.use(function() {
